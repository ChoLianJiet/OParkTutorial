...
public class BrandsOfferFragment extends Fragment implements BrandsTitleAdapter.BrandsSelected {
...
//                            Log.d("brands", "in m: " + dataSnapshot.getValue(MerchantOffer.class).getMerchantName().charAt(0));
                            ...
                            case 'X':
                                ...
                                break;
                            case 'Y':
                                addMerchantsBrandName1(alphabet, dataSnapshot, recViewY, brandsNamesListY, brandsNameListStringY, brandsOfferY);
...
//                    brandsOfferList.clear();
                    ...
                    BrandsOfferFragmentHost.brandsOfferFragMan.beginTransaction().replace(R.id.frame_container,new ShowBrandOffer(),"showingbrand")
                            .commit();
