...
//import com.opark.opark.TextView;

import com.opark.opark.R;

import org.w3c.dom.Text;

public class SearchViewBehavior1 extends CoordinatorLayout.Behavior<TextView> {
    ...
    private float SearchViewMaxSize;
    ...
    public SearchViewBehavior1() {
    }

    public SearchViewBehavior1(Context context, AttributeSet attrs) {
    ...
    private void bindDimensions() {
        SearchViewMaxSize = mContext.getResources().getDimension(R.dimen.activity_horizontal_margin);
    }
