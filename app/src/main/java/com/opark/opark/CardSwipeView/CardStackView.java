...
public class CardStackView extends FrameLayout {
    ...
    public CardStackView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, com.opark.opark.R.styleable.CardStackView);
        setVisibleCount(array.getInt(com.opark.opark.R.styleable.CardStackView_visibleCount, option.visibleCount));
        setSwipeThreshold(array.getFloat(com.opark.opark.R.styleable.CardStackView_swipeThreshold, option.swipeThreshold));
        setTranslationDiff(array.getFloat(com.opark.opark.R.styleable.CardStackView_translationDiff, option.translationDiff));
        setScaleDiff(array.getFloat(com.opark.opark.R.styleable.CardStackView_scaleDiff, option.scaleDiff));
        setStackFrom(StackFrom.values()[array.getInt(com.opark.opark.R.styleable.CardStackView_stackFrom, option.stackFrom.ordinal())]);
        setElevationEnabled(array.getBoolean(com.opark.opark.R.styleable.CardStackView_elevationEnabled, option.isElevationEnabled));
        setSwipeEnabled(array.getBoolean(com.opark.opark.R.styleable.CardStackView_swipeEnabled, option.isSwipeEnabled));
        setSwipeDirection(SwipeDirection.from(array.getInt(com.opark.opark.R.styleable.CardStackView_swipeDirection, 0)));
        setLeftOverlay(array.getResourceId(com.opark.opark.R.styleable.CardStackView_leftOverlay, 0));
        setRightOverlay(array.getResourceId(com.opark.opark.R.styleable.CardStackView_rightOverlay, 0));
        setBottomOverlay(array.getResourceId(com.opark.opark.R.styleable.CardStackView_bottomOverlay, 0));
        setTopOverlay(array.getResourceId(com.opark.opark.R.styleable.CardStackView_topOverlay, 0));
        array.recycle();
    }
    ...
    private void initializeViews() {
        ...
        for (int i = 0; i < option.visibleCount; i++) {
            CardContainerView view = (CardContainerView) LayoutInflater.from(getContext())
                    .inflate(com.opark.opark.R.layout.card_container, this, false);
    ...
    private void moveToBottom(CardContainerView container) {
        com.opark.opark.CardSwipeView.CardStackView parent = (com.opark.opark.CardSwipeView.CardStackView) container.getParent();
        if (parent != null) {
