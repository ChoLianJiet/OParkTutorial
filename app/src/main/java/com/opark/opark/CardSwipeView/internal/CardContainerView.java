package com.opark.opark.CardSwipeView.internal;
...
public class CardContainerView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        inflate(getContext(), com.opark.opark.R.layout.card_frame, this);
        contentContainer = (ViewGroup) findViewById(com.opark.opark.R.id.card_frame_content_container);
        overlayContainer = (ViewGroup) findViewById(com.opark.opark.R.id.card_frame_overlay_container);
    }
    ...
    private void handleActionUp(MotionEvent event) {
        if (isDragging) {
            ...
            Point point = com.opark.opark.CardSwipeView.internal.Util.getTargetPoint(motionOriginX, motionOriginY, motionCurrentX, motionCurrentY);
            Quadrant quadrant = com.opark.opark.CardSwipeView.internal.Util.getQuadrant(motionOriginX, motionOriginY, motionCurrentX, motionCurrentY);
